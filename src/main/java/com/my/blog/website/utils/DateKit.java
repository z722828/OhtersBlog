...
public class DateKit {
    ...
    public static final int INTERVAL__MINUTE = 6;
...

    {
        ...
        dateFormats.add(new SimpleDateFormat("yyyy/MM/dd"));
        dateFormats.add(new SimpleDateFormat("yyyy.MM.dd"));
        dateFormats.add(new SimpleDateFormat("yyyy-MM-dd HH:24:mm:ss"));
        dateFormats.add(new SimpleDateFormat("yyyy/MM/dd HH:24:mm:ss"));
        dateFormats.add(new SimpleDateFormat("yyyy.MM.dd HH:24:mm:ss"));
    ...
    public static long DaysBetween(Date date1, Date date2) {
        ...
        long day = (date2.getTime()-date1.getTime()) / 86400000L;  //毫秒换算成天
        return day;
    }
    ...
    public static boolean isExpireDay(Date date1) {
